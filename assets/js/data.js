 // ===== DRAWER DE CLASSES DE RISCO =====
  ...
  function r(name, ctrl, code, opts) {
    let obj;
  ...
  const SHELF_DATA = {
    ...
    L1:{ icon:'🔥', title:'Solventes aromáticos & pesados — estoque', short:'Benzeno · Tolueno · Ciclohexano · Éter de Petróleo',
         ...
         reagents:[r('Benzeno',PF2,'E9',{carc:true}), r('Tolueno',PF2,'E21'), r('Ciclohexano',null,'E10'), r('Ciclohexanona',null,'E11'), r('Éter de Petróleo',null,'E14')],
         ctrl:[PF2],
    ...
    L2:{ icon:'🔥', title:'Solventes halogenados & especiais', short:'Clorofórmio · Acetato de Etila · DMF',
         ...
         reagents:[r('Clorofórmio',PF2,'E12',{carc:true}), r('Acetato de Etila',PF2,'E1'), r('N,N-Dimetilformamida (DMF)',null,'E18',{carc:true})],
         ctrl:[PF2],
    ...
    L3:{ icon:'🔥', title:'Álcoois, acetona e ácido acético glacial (uso diário)', short:'Acetona · Etanol · Metanol · Isopropanol · AcOH Glacial',
         ...
         ctrl:[PF2],
         rule:'⚡ Acetona: PF Lista II — SIPROQUIM 2. AcOH Glacial: PF Lista IV. Frascos vedados. ⚠️ NÃO armazenar AcOH Glacial diretamente abaixo de H₂SO₄ ou HCl concentrados.', rc:'rgba(255,107,43,0.12)', rt:'#ff8850' },
    L4:{ icon:'🔥', title:'Solventes leves — reserva 🪜', short:'N-Hexano · Éter de Petróleo reserva · A reclassificar',
         ...
         ctrl:[],
         rule:'🪜 Acesso com escada. E4: RECLASSIFICAR antes do uso. ⚠️ N-Hexano (E19): neurotóxico — metabolito 2,5-hexanodiona causa neuropatia periférica irreversível; evitar inalação crônica, usar somente em capela.', rc:'rgba(255,107,43,0.12)', rt:'#ff8850' },
    ...
    R1:{ icon:'🧂', title:'Bases fortes — base da estante', short:'NaOH · KOH · Ca(OH)₂ · CaO · Al(OH)₃',
         ...
         reagents:[r('Hidróxido de Sódio',null,'B22'), r('Hidróxido de Potássio',null,'B21'), r('Hidróxido de Cálcio',null,'B20'), r('Óxido de Cálcio (Cal)',null,'B30'), r('Suspensão Al(OH)₃',null,'B39')],
         ctrl:[],
    ...
    R2:{ icon:'🧂', title:'Sulfatos, carbonatos e fosfatos', short:'FeSO₄ · MgSO₄ · MnSO₄ · Al₂(SO₄)₃ · Na₂CO₃ · K₂CO₃ · Fosfatos · FeCl₃',
         ...
         reagents:[r('Sulfato de Ferro',null,'B34'), r('Sulfato de Magnésio',null,'B35'), r('Sulfato de Manganês',null,'B36'), r('Sulfato de Alumínio',null,'B33'), r('Carbonato de Sódio',null,'B8'), r('Carbonato de Potássio',null,'B7'), r('Fosfatos de Sódio/Potássio',null,'B18'), r('Cloreto de Ferro (FeCl₃)',null,'B13'), r('Cloreto de Cálcio / Magnésio',null,'B12')],
         ctrl:[],
         rule:'FeCl₃ (B13): extremidade direita — pode interferir com tiossulfato em R4.', rc:'rgba(32,120,200,0.10)', rt:'#5599dd' },
    R3:{ icon:'🧂', title:'Sais de uso analítico (PF Lista V)', short:'NH₄OH · NaCl · Acetatos · Oxalatos · KBr · NaI',
         desc:'Sais analíticos gerais. Hidróxido de amônio: PF Lista V. NaI na extremidade esquerda.',
         reagents:[r('Hidróxido de Amônio',PF5,'B19'), r('Cloreto de Sódio',null,'B14'), r('Acetato de Sódio',null,'B2'), r('Acetato de Amônio',null,'B1'), r('Oxalato de Sódio',null,'B29'), r('Oxalato de Amônio',null,'B28'), r('Brometo de Potássio',null,'B6'), r('Iodeto de Sódio (NaI)',null,'B26'), r('Iodeto de Potássio (KI)',null,'B25'), r('Citrato de Amônio Dibásico',null,'B10'), r('Amônio Monohidratado',null,'B3'), r('Mistura Combinada (Fosfato/Ortofosfato)',null,'B27'), r('Caulim',null,'B9'), r('Fosfato Monopotássio (KH₂PO₄)',null,'B17'), r('Fosfato Dipotássico (K₂HPO₄)',null,'B16')],
         ctrl:[PF5],
         rule:'🔒 NH₄OH: PF Lista V. NaI (B26) e KI (B25): extremidade esquerda — longe de Cloreto de Ferro/oxidantes (Fe³⁺ libera I₂).', rc:'rgba(32,120,200,0.10)', rt:'#5599dd' },
    R4:{ icon:'🧂', title:'Redutores, complexantes e hidroxilaminas 🪜', short:'SnCl₂ ⬅️ · EDTA · Tiossulfato · NH₂OH ➡️',
         ...
         reagents:[r('Cloreto Estanhoso (SnCl₂)',null,'B15'), r('Tiossulfato de Sódio',null,'B41'), r('Sal Dissódico EDTA',null,'B31'), r('Sol. Sulfato Ferroso Amoniacal',null,'B32'), r('Cloreto de Amônio',PF6,'B11'), r('Hidroxilamina',PF6,'B23'), r('Hidroxilamina Cloridrato',PF6,'B24')],
         ctrl:[PF6],
         rule:'🪜🔒 SnCl₂ ponta esquerda. Hidroxilaminas ponta direita. PF Lista VI. Sulfato ferroso amon. (B32): redutor — oxida ao ar, longe de oxidantes.', rc:'rgba(32,120,200,0.10)', rt:'#5599dd' },
    R5:{ icon:'🧂', title:'Indicadores e corantes 🪜', short:'Alaranjado · Azul Metileno · Fenolftaleína · Ditizona · Amido · Indigo',
         desc:'Todos os indicadores volumétricos e corantes analíticos consolidados nesta prateleira. Acesso com escada. ⚠️ Fenolftaleína (Ind9) e Ditizona (Ind7): EPI completo.',
         reagents:[r('Alaranjado de Metila',null,'Ind1'), r('Alizarin Sulfonato de Sódio P.A',null,'Ind2'), r('Amido Solúvel',null,'Ind3'), r('Azul de Metileno',null,'Ind4'), r('Azul de Timol',null,'Ind5'), r('Cristal Violeta',null,'Ind6'), r('Ditizona',null,'Ind7'), r('Fenantrolina Monohidratada 1,10',null,'Ind8'), r('Sol. Ortofenantrolina',null,null), r('Fenolftaleína (sólido)',null,'Ind9',{carc:true}), r('Sol. Fenolftaleína',null,null,{carc:true}), r('Indigo Blue Padrão',null,'Ind10'), r('Murexida',null,'Ind11'), r('Negro de Eriocromo T',null,'Ind12'), r('Sol. Ortotolidina',null,null,{carc:true}), r('Safranina',null,'Ind13'), r('Verde de Bromocresol',null,'Ind14'), r('Vermelho de Metila',null,'Ind15')],
         ctrl:[],
         rule:'🪜 ⚠️ Fenolftaleína sólida (Ind9) e Ditizona (Ind7): carcinogênicas suspeitas — EPI completo. Sol. Ortofenantrolina: longe das soluções-estoque de ferro (F5).', rc:'rgba(32,120,200,0.08)', rt:'#5599dd' },
    R6:{ icon:'🧂', title:'Boratos, sulfatos alcalinos e sulfito 🪜', short:'Bórax · Borato · KHCO₃ · Na₂SO₃ · Na₂SO₄',
         ...
         reagents:[r('Tetraborato de Sódio / Bórax',null,'B40'), r('Borato de Sódio Anidro',null,'B5'), r('Bicarbonato de Potássio',PF5,'B4'), r('Sulfito de Sódio',null,'B38'), r('Sulfato de Sódio',null,'B37')],
         ctrl:[PF5],
    ...
    F1:{ icon:'☠️', title:'COFRE — Cianetos, Mercúrio, Arsenito, Azida', short:'🟡 Azida · 🔴 Cianeto/Nitroprussiato/Arsenito · ⚫ Hg',
         ...
         reagents:[r('[🟡] Azida Sódica',COFRE,'T3'), r('[🔴] Cianeto de Potássio',COFRE,'T6'), r('[🔴] Nitroprussiato de Sódio',COFRE,'T24'), r('[🔴] Meta-Arsenito de Sódio',COFRE,'T19',{carc:true}), r('[⚫] Cloreto de Mercúrio',COFRE,'T8'), r('[⚫] Sulfato de Mercúrio',COFRE,'T33'), r('[⚫] Óxido de Mercúrio II',COFRE,'T27'), r('[⚫] Iodeto de Mercúrio II',COFRE,'T18')],
         ctrl:[COFRE],
    ...
    F2:{ icon:'☠️', title:'Sais de prata, metais pesados e fenol', short:'AgNO₃ · Ag₂SO₄ · CoCl₂ · CuSO₄ · NiSO₄ · Fenol',
         ...
         reagents:[r('Nitrato de Prata (sólido)',null,'T22'), r('Sol. AgNO₃ (várias)'), r('Sulfato de Prata',null,'T35'), r('Nitrato de Paládio',null,'T21'), r('Cloreto de Cobalto II',null,'T7',{carc:true}), r('Oxicloreto de Zircônio',null,'T26'), r('Antimônio Padrão (AAS)',null,'T2',{carc:true}), r('Sulfato de Cobre II',null,'T32'), r('Sulfato de Níquel',null,'T34',{carc:true}), r('Amônio Metavanadato',null,'T1',{carc:true}), r('Fenol / Ácido Fênico',null,'T13')],
         ctrl:[],
    ...
    F3:{ icon:'💥', title:'Oxidantes sólidos (PF Lista VI)', short:'⬅️ KMnO₄/Cromatos/Bromato/Iodato · ➡️ H₂O₂/Persulfatos · NaNO₂ isolado',
         ...
         reagents:[r('Permanganato de Potássio',PF6,'T28'), r('Dicromato de Potássio',PF6,'T10',{carc:true}), r('Cromato de Potássio',PF6,'T9',{carc:true}), r('Bicromato de Potássio',PF6,'T4',{carc:true}), r('Bromato de Potássio',null,'T5',{carc:true}),r('Iodato de Potássio',null,'T17'), r('Peróxido de Hidrogênio H₂O₂',null,'T29'), r('Persulfato de Amônio',null,'T30'), r('Persulfato de Potássio',null,'T31'), r('Nitrito de Sódio',null,'T23',{carc:true}), r('Nitrato de Cálcio',null,'T20'), r('Nitrato de Magnésio Hexaidratado',null,'T36'), r('Hipoclorito de Cálcio 65%',null,'T15')],
         ctrl:[PF6],
    ...
    F6:{ icon:'☠️', title:'Tóxicos orgânicos e não identificados 🪜', short:'O-Toluidina · DDTC · Sulfeto de Sódio · Formiato Na',
         ...
         reagents:[r('O-Toluidina',null,'T25',{carc:true}), r('Dietilditiocarbamato de Sódio',null,'T11'), r('Formiato de Sódio',null,'T14'), r('Sulfeto de Sódio',null,'T37'), r('Reagentes a identificar')],
         ctrl:[],
  ...
  const CODES_DB = {
    ...
    'B3':  { name:'Amônio Monohidratado',                 shelf:'R3', wall:'Direita/Sais+Bases' },
    'B4':  { name:'Bicarbonato de Potássio',              shelf:'R6', wall:'Direita/Sais+Bases' },
    'B5':  { name:'Borato de Sódio Anidro',               shelf:'R6', wall:'Direita/Sais+Bases' },
    'B6':  { name:'Brometo de Potássio',                  shelf:'R3', wall:'Direita/Sais+Bases' },
    'B7':  { name:'Carbonato de Potássio',                shelf:'R2', wall:'Direita/Sais+Bases' },
    'B8':  { name:'Carbonato de Sódio',                   shelf:'R2', wall:'Direita/Sais+Bases' },
    'B9':  { name:'Caulim',                               shelf:'R3', wall:'Direita/Sais+Bases' },
    'B10': { name:'Citrato de Amônio Dibásico',           shelf:'R3', wall:'Direita/Sais+Bases' },
    'B11': { name:'Cloreto de Amônio',                    shelf:'R4', wall:'Direita/Sais+Bases' },
    'B12': { name:'Cloreto de Cálcio / Magnésio',         shelf:'R2', wall:'Direita/Sais+Bases' },
    'B13': { name:'Cloreto de Ferro (FeCl₃)',             shelf:'R2', wall:'Direita/Sais+Bases' },
    'B14': { name:'Cloreto de Sódio',                     shelf:'R3', wall:'Direita/Sais+Bases' },
    'B15': { name:'Cloreto Estanhoso (SnCl₂)',            shelf:'R4', wall:'Direita/Sais+Bases' },
    'B16': { name:'Fosfato Dipotássico (K₂HPO₄)',         shelf:'R3', wall:'Direita/Sais+Bases' },
    'B17': { name:'Fosfato Monopotássico (KH₂PO₄)',       shelf:'R3', wall:'Direita/Sais+Bases' },
    'B18': { name:'Fosfatos de Sódio/Potássio',           shelf:'R2', wall:'Direita/Sais+Bases' },
    'B19': { name:'Hidróxido de Amônio',                  shelf:'R3', wall:'Direita/Sais+Bases' },
    'B20': { name:'Hidróxido de Cálcio',                  shelf:'R1', wall:'Direita/Sais+Bases' },
    'B21': { name:'Hidróxido de Potássio',                shelf:'R1', wall:'Direita/Sais+Bases' },
    'B22': { name:'Hidróxido de Sódio',                   shelf:'R1', wall:'Direita/Sais+Bases' },
    'B23': { name:'Hidroxilamina',                        shelf:'R4', wall:'Direita/Sais+Bases' },
    'B24': { name:'Hidroxilamina Cloridrato',             shelf:'R4', wall:'Direita/Sais+Bases' },
    'B25': { name:'Iodeto de Potássio (KI)',              shelf:'R3', wall:'Direita/Sais+Bases' },
    'B26': { name:'Iodeto de Sódio (NaI)',                shelf:'R3', wall:'Direita/Sais+Bases' },
    'B27': { name:'Mistura Combinada (Fosfato/Ortofosfato)', shelf:'R3', wall:'Direita/Sais+Bases' },
    'B28': { name:'Oxalato de Amônio',                    shelf:'R3', wall:'Direita/Sais+Bases' },
    'B29': { name:'Oxalato de Sódio',                     shelf:'R3', wall:'Direita/Sais+Bases' },
    'B30': { name:'Óxido de Cálcio (Cal)',                shelf:'R1', wall:'Direita/Sais+Bases' },
    'B31': { name:'Sal Dissódico EDTA',                   shelf:'R4', wall:'Direita/Sais+Bases' },
    'B32': { name:'Sol. Sulfato Ferroso Amoniacal',       shelf:'R4', wall:'Direita/Sais+Bases' },
    'B33': { name:'Sulfato de Alumínio',                  shelf:'R2', wall:'Direita/Sais+Bases' },
    'B34': { name:'Sulfato de Ferro',                     shelf:'R2', wall:'Direita/Sais+Bases' },
    'B35': { name:'Sulfato de Magnésio',                  shelf:'R2', wall:'Direita/Sais+Bases' },
    'B36': { name:'Sulfato de Manganês',                  shelf:'R2', wall:'Direita/Sais+Bases' },
    'B37': { name:'Sulfato de Sódio',                     shelf:'R6', wall:'Direita/Sais+Bases' },
    'B38': { name:'Sulfito de Sódio',                     shelf:'R6', wall:'Direita/Sais+Bases' },
    'B39': { name:'Suspensão Al(OH)₃',                   shelf:'R1', wall:'Direita/Sais+Bases' },
    'B40': { name:'Tetraborato de Sódio / Bórax',         shelf:'R6', wall:'Direita/Sais+Bases' },
    'B41': { name:'Tiossulfato de Sódio',                 shelf:'R4', wall:'Direita/Sais+Bases' },
    ...
    'IND1':  { name:'Alaranjado de Metila',               shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND2':  { name:'Alizarin Sulfonato de Sódio P.A',   shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND3':  { name:'Amido Solúvel',                      shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND4':  { name:'Azul de Metileno',                   shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND5':  { name:'Azul de Timol',                      shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND6':  { name:'Cristal Violeta',                    shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND7':  { name:'Ditizona',                           shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND8':  { name:'Fenantrolina Monohidratada 1,10',   shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND9':  { name:'Fenolftaleína (sólido)',             shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND10': { name:'Indigo Blue Padrão',                 shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND11': { name:'Murexida',                           shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND12': { name:'Negro de Eriocromo T',               shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND13': { name:'Safranina',                          shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND14': { name:'Verde de Bromocresol',               shelf:'R5', wall:'Direita/Sais+Bases' },
    'IND15': { name:'Vermelho de Metila',                 shelf:'R5', wall:'Direita/Sais+Bases' },
  };

  // ===================== FICHAS DE RISCO RÁPIDO =====================
  const FICHAS_RISCO = [
    {
      code:'A12', name:'Ácido Nítrico concentrado', formula:'HNO₃',
      wall_loc:'Fundo / B1', carc:false,
      ghs:['GHS03 Oxidante','GHS05 Corrosivo','GHS07 Irritante'],
      hphrases:['H272 — Pode agravar incêndio; oxidante','H314 — Causa queimaduras graves na pele e lesões oculares','H331 — Tóxico por inalação (vapores de NO₂)','H290 — Pode ser corrosivo para metais'],
      epi:['Luvas nitrila/neoprene dupla','Óculos vedados (não óculos simples)','Jaleco e proteção facial','Máscara P100+OV se vapor presente'],
      incomp_sala:['🔥 Inflamáveis / parede Esquerda (L1–L4): reação exotérmica intensa, liberação de NO₂ laranja','🧂 Redutores (R4 – SnCl₂, EDTA): oxidação violenta','🟣 Cianetos/Azida COFRE (F1): geração de HCN/HN₃ em caso de derramamento cruzado','🟣 Sulfeto de Sódio (F6/T37): H₂S letal + nuvem de SO₂'],
      emergencia:['Derramamento: cobrir com NaHCO₃ sólido, absorver com areia, container específico','Pele: lavar com água corrente por ≥15 min — NUNCA tentar neutralizar na pele','Olhos: lavar com água por ≥15 min, médico obrigatório','Inalação: sair para ar fresco; se tosse persistente, médico urgente'],
      descarte:'Neutralizar com NaHCO₃ até pH 6–9; entregar a empresa de coleta de ácidos inorgânicos — NUNCA lançar na pia.'
    },
    {
      code:'A16', name:'Ácido Sulfúrico concentrado', formula:'H₂SO₄',
      wall_loc:'Fundo / B2', carc:false,
      ghs:['GHS05 Corrosivo','GHS07 Irritante'],
      hphrases:['H314 — Causa queimaduras graves na pele e lesões oculares','H335 — Pode irritar as vias respiratórias','H290 — Pode ser corrosivo para metais'],
      epi:['Luvas de nitrila espessa ou neoprene','Óculos vedados','Jaleco e proteção facial se manipular volumes > 100 mL','Manipular SEMPRE em bandeja de contenção'],
      incomp_sala:['💧 Água: mistura extremamente exotérmica — SEMPRE adicionar ácido à água, nunca o contrário','🧂 Bases R1 (NaOH/KOH): neutralização violenta com calor','🔥 Solventes orgânicos parede L: carbonização e ignição possível','🟣 KMnO₄ (F3/T28): mistura gera Mn₂O₇ explosivo','🧂 Cloretos: liberação de HCl gasoso'],
      emergencia:['Derramamento: absorver com areia SECA (nunca serragem), depois neutralizar com NaHCO₃','Pele: lavar com água abundante ≥15 min — queimadura grave; médico obrigatório','Olhos: lavar com água ≥15 min; médico de emergência','Inalação de névoa: ar fresco, médico se irritação persistir'],
      descarte:'Neutralizar com NaHCO₃ até pH 6–9; container ácidos inorgânicos — empresa licenciada.'
    },
    {
      code:'A8', name:'Ácido Clorídrico concentrado', formula:'HCl',
      wall_loc:'Fundo / B2', carc:false,
      ghs:['GHS05 Corrosivo','GHS07 Irritante'],
      hphrases:['H314 — Causa queimaduras graves','H335 — Irrita vias respiratórias','H290 — Corrosivo para metais'],
      epi:['Luvas nitrila','Óculos vedados','Jaleco','Uso obrigatório em exaustor — libera HCl gasoso mesmo fechado'],
      incomp_sala:['🟣 KMnO₄ (F3/T28): gera Cl₂ tóxico (amarelo-esverdeado) — extremamente perigoso','🔴 Cromatos/Dicromatos (F3): reação oxidativa com geração de Cl₂','🧂 Bases fortes R1: neutralização exotérmica','🟣 Cianetos (F1 COFRE): gera HCN se misturado'],
      emergencia:['Derramamento: ventilar imediatamente, neutralizar com NaHCO₃, absorver com areia','Pele/olhos: lavar com água ≥15 min','Inalação: ar fresco; se tosse ou dor no peito, SAMU/emergência'],
      descarte:'Neutralizar com NaHCO₃ até pH 6–9; container ácidos inorgânicos.'
    },
    {
      code:'T6', name:'Cianeto de Potássio / Azida Sódica', formula:'KCN / NaN₃',
      wall_loc:'Frente / F1 — COFRE', carc:false,
      ghs:['GHS06 Crânio (toxicidade aguda Cat.1)','GHS09 Perigo ambiental'],
      hphrases:['H290 — Corrosivo para metais','H310 — Fatal em contato com a pele','H330 — Fatal por inalação','H410 — Muito tóxico para organismos aquáticos com efeitos duradouros','H290 (Azida) — Explosivo em contato com ácidos'],
      epi:['Luvas nitrila DUPLA (trocar após cada uso)','Óculos vedados','Jaleco','Máscara full-face com filtro ABEK/CN','NUNCA trabalhar sozinho com cianeto'],
      incomp_sala:['🔴 HNO₃ / HCl / H₂SO₄ (parede Fundo): derramamento cruzado → HCN (letal, odor amêndoa) ou HN₃ (azida)','🟣 KMnO₄ / Cromatos (F3): reação oxidativa perigosa','⚠️ Qualquer ácido — pH < 7 libera HCN instantaneamente'],
      emergencia:['Exposição: SAMU/119 imediatamente — intoxicação por cianeto é emergência médica','Derramamento: evacuar área, SCBA obrigatório para quem entrar, kit antídoto (hidroxicobalamina)','Pele: lavar com água ≥20 min, remover roupas, médico urgente','NUNCA fazer respiração boca-a-boca em vítima de cianeto'],
      descarte:'EXCLUSIVAMENTE via empresa habilitada para resíduos cianídricos — NUNCA lançar na pia ou neutralizar sem orientação técnica.'
    },
    {
      code:'T19', name:'Meta-Arsenito de Sódio', formula:'NaAsO₂',
      wall_loc:'Frente / F1 — COFRE', carc:true,
      ghs:['GHS06 Crânio (Cat.1)','GHS08 Perigo à saúde — IARC Grupo 1'],
      hphrases:['H301 — Tóxico por ingestão','H310 — Fatal em contato com a pele','H330 — Fatal por inalação','H350 — IARC Grupo 1: causa câncer (pele, pulmão, bexiga)'],
      epi:['Luvas nitrila dupla','Óculos vedados','Máscara P100','Jaleco de manga longa','NÃO gerar pó — usar em área ventilada'],
      incomp_sala:['🔴 Oxidantes fortes F3 (KMnO₄, Cromatos, H₂O₂): oxidação para arsenato tóxico e reação exotérmica','🔴 Ácidos parede Fundo: dissolução e aumento da volatilidade'],
      emergencia:['Ingestão: NUNCA induzir vômito; SAMU imediatamente','Pele: lavar abundantemente ≥20 min, médico urgente','Inalação de pó: ar fresco, médico — pode não haver sintoma imediato','Derramamento: área restrita, roupas protetoras, molhar para evitar pó'],
      descarte:'Empresa especializada em resíduos de metais pesados/arsênio — registro obrigatório de quantidade.'
    },
    {
      code:'T28', name:'Permanganato de Potássio', formula:'KMnO₄',
      wall_loc:'Frente / F3', carc:false,
      ghs:['GHS03 Oxidante','GHS05 Corrosivo','GHS07 Irritante','GHS09 Ambiental'],
      hphrases:['H272 — Pode agravar incêndio; oxidante forte','H314 — Corrosivo para pele e olhos','H400 — Muito tóxico para organismos aquáticos'],
      epi:['Luvas nitrila','Óculos de proteção','Jaleco','NÃO inalar pó violeta — irritante respiratório'],
      incomp_sala:['🔥 Glicerina / Glicerol (L5/E17): contato → ignição ESPONTÂNEA sem faísca','🔥 Metanol / Etanol (L2/L3/E7/E13): reação violenta com chama','🔴 H₂SO₄ conc. (B2): mistura → Mn₂O₇ oleoso, explosivo e altamente oxidante','🔴 HCl conc. (B2): gera Cl₂ tóxico','🔥 Qualquer solvente orgânico parede Esquerda: risco de ignição'],
      emergencia:['Derramamento: diluir com ÁGUA abundante (não use serragem — combustível)','Pele/manchas roxas: lavar com água; desaparecem lentamente','Olhos: lavar com água ≥15 min, médico','Fogo com KMnO₄: água nebulizada — NÃO usar CO₂ (ineficaz)'],
      descarte:'Container oxidantes; NUNCA junto com orgânicos ou resíduos inflamáveis.'
    },
    {
      code:'T37', name:'Sulfeto de Sódio', formula:'Na₂S',
      wall_loc:'Frente / F6', carc:false,
      ghs:['GHS05 Corrosivo','GHS06 Tóxico','GHS09 Ambiental'],
      hphrases:['H290 — Corrosivo para metais','H311 — Tóxico em contato com a pele','H331 — Tóxico por inalação (H₂S)','H400/H410 — Muito tóxico para organismos aquáticos'],
      epi:['Luvas nitrila','Óculos vedados','Máscara P100+OV (H₂S não tem aviso olfativo em altas conc.)','Jaleco — manipular APENAS em exaustor'],
      incomp_sala:['🔴 TODOS os ácidos (HNO₃ B1, H₂SO₄/HCl B2, AcOH B3, ácidos orgânicos B4): reação → H₂S, gás incolor LETAL (TLV 1 ppm — paralisa olfato acima de 50 ppm)','🔴 Oxidantes F3 (KMnO₄, Cromatos, H₂O₂): reação exotérmica com risco de ignição','⚠️ QUALQUER ácido — mesmo vinagre — pode gerar H₂S suficiente para matar em espaço confinado'],
      emergencia:['H₂S liberado: EVACUAR IMEDIATAMENTE — não reentrar sem SCBA','SAMU/Corpo de Bombeiros (192/193) — inalação de H₂S é emergência','Pele: lavar abundantemente com água','Derramamento: neutralizar APENAS com solução de hipoclorito (oxidação do sulfeto)'],
      descarte:'Oxidar com hipoclorito de sódio antes do descarte; empresa licenciada para resíduos sulfídricos.'
    },
    {
      code:'T23', name:'Nitrito de Sódio', formula:'NaNO₂',
      wall_loc:'Frente / F3 — bandeja isolada', carc:true,
      ghs:['GHS03 Oxidante','GHS06 Tóxico','GHS08 Perigo à saúde — IARC 2A'],
      hphrases:['H272 — Oxidante','H302 — Nocivo por ingestão','H410 — Tóxico aquático','H351 — Suspeito de causar câncer (IARC 2A)'],
      epi:['Luvas nitrila','Óculos de proteção','Jaleco','Ventilação adequada'],
      incomp_sala:['🧂 Sais de amônio (R3 – NH₄Cl B13, NH₄OH B22): reação → N₂ + H₂O exotérmica; em concentrado → EXPLOSÃO','🔴 Ácidos: libera HNO₂ instável → decompõe em NOₓ tóxico','🟣 Cianetos (F1): oxidação do CN⁻','⚠️ NaNO₂ deve ficar em bandeja ISOLADA dentro de F3 — longe dos demais oxidantes'],
      emergencia:['Ingestão: médico urgente — causa metemoglobinemia (sangue incapaz de transportar O₂)','Pele: lavar com água 15 min','Derramamento: neutralizar com NaHCO₃, não misturar com amônio ou ácidos'],
      descarte:'Oxidar com H₂O₂ diluído até nitrato; container oxidantes; empresa licenciada.'
    },
    {
      code:'E9', name:'Benzeno', formula:'C₆H₆',
      wall_loc:'Esquerda / L1', carc:true,
      ghs:['GHS02 Inflamável','GHS06 Tóxico','GHS08 Carcinogênico — IARC Grupo 1'],
      hphrases:['H225 — Líquido e vapores altamente inflamáveis','H304 — Pode ser letal se ingerido/aspirado','H315/H319 — Irritação','H340 — Pode causar anomalias genéticas','H350 — CAUSA câncer (leucemia — IARC Grupo 1)','H372 — Danos aos órgãos (medula óssea) em exposição repetida'],
      epi:['Luvas nitrila dupla (trocar após cada uso — penetra em minutos)','Óculos vedados','Jaleco','Máscara OV+P100 OBRIGATÓRIA','USO EXCLUSIVO em CAPELA com fluxo de ar verificado'],
      incomp_sala:['🔴 Oxidantes F3 (KMnO₄, Cromatos, H₂O₂): reação violenta','⚡ Fontes de ignição: ponto de fulgor −11 °C — vapores inflamam à temperatura ambiente','⚠️ Sem ventilação: vapores invisíveis acumulam ao nível do chão'],
      emergencia:['Derramamento: eliminar fontes de ignição, areia ou vermiculita para absorver — NUNCA serragem','Inalação: ar fresco imediato; médico obrigatório — efeitos crônicos não têm sintoma agudo óbvio','Pele: lavar com água e sabão ≥15 min','Fogo: CO₂ ou pó químico seco; NÃO usar água em jato (espalhamento)'],
      descarte:'Container de solventes aromáticos; incineração controlada em empresa licenciada — NUNCA evaporar ao ar.'
    },
    {
      code:'T10', name:'Cromatos / Dicromatos Cr(VI)', formula:'K₂Cr₂O₇ / K₂CrO₄',
      wall_loc:'Frente / F3', carc:true,
      ghs:['GHS03 Oxidante','GHS05 Corrosivo','GHS07 Irritante','GHS08 Carcinogênico — IARC Grupo 1'],
      hphrases:['H272 — Oxidante forte','H302 — Nocivo por ingestão','H317 — Pode causar reação alérgica cutânea','H318 — Causa lesão ocular grave','H334 — Pode causar sintomas de alergia/asma','H340 — Pode causar anomalias genéticas','H350 — CAUSA câncer (pulmão — IARC Grupo 1)','H360 — Pode prejudicar fertilidade e bebê'],
      epi:['Luvas nitrila (NÃO usar látex — alergênico)','Óculos vedados','Jaleco','Máscara P100 se manipular sólido em pó','NÃO gerar pó — molhar levemente antes de pesar'],
      incomp_sala:['🔥 Inflamáveis / orgânicos parede Esquerda: oxidação violenta com possível ignição','🔴 H₂SO₄ (B2) + redutor: mistura ácida de Cr(VI) muito corrosiva','🧂 Redutores (R4 – SnCl₂, tiossulfato): reação exotérmica','⚠️ Controlado PF Lista VI — registro de uso obrigatório'],
      emergencia:['Derramamento de sólido: molhar PRIMEIRO (reduz geração de pó), recolher com pá úmida','Pele: lavar ≥15 min com água; verificar sensibilização (úlceras crônicas)','Olhos: lavar ≥15 min; médico obrigatório','Inalação de pó: médico — risco de sensibilização permanente'],
      descarte:'Container específico para metais pesados (Cr(VI)); empresa licenciada — NUNCA misturar com outros resíduos.'
    },
  ];
